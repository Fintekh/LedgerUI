...
export const employees = {
  getAll: () => getAll<any>('employees'),
  getById: (id: string) => getById<any>('employees', id),
  create: (data: any) => create<any>('employees', data),
  update: (id: string, data: any) => update<any>('employees', id, data),
  remove: (id: string) => remove('employees', id),
  getByDepartment: (department: string) => 
    getFiltered<any>('employees', { department }),
};
